...
using p4g64.simplelocalizationfixes.Configuration;
using p4g64.simplelocalizationfixes.Template.Configuration;
using Reloaded.Hooks.ReloadedII.Interfaces;
using Reloaded.Mod.Interfaces;
using Reloaded.Mod.Interfaces.Internal;

namespace p4g64.simplelocalizationfixes.Template
{
